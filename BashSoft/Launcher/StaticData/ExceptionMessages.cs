...
namespace BashSoft
{
    public static class ExceptionMessages
    {
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "The folder that you are trying to reach does not exist.";

        //FIFTH LAB - PROBLEM 2.
        //public const string InvalidCommandMessage = $"The command '{input}' is invalid";
        ...
        public const string StudentAlreadyEnrolledInGivenCourse = "{0} already exists in {1}.";
